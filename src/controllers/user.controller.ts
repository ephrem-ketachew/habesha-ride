...
export const updateProfileHandler = catchAsync(
  async (req: Request<{}, {}, UpdateProfileInput>, res: Response) => {
    ...
    const forbidden = ["password","passwordConfirm","role","status","emailVerificationToken","emailVerificationTokenExpires","phoneOtp","phoneOtpExpires","passwordResetToken","passwordResetExpires"];
    forbidden.forEach(f => {
