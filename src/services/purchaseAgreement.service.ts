...
export const generatePurchaseAgreement = async (
  ...
  doc
    .fontSize(14)
    .font('Helvetica-Bold')
    .text('FINANCIAL TERMS', { underline: true });
  doc.moveDown(0.5);
  doc
    .fontSize(10)
    .font('Helvetica')
    ...
    .text(
      `Reservation Fee (Paid): ${reservation.reservationFee.toLocaleString()} ETB`,
    )
    .text(
      `Final Settlement Amount: ${reservation.finalSettlementAmount.toLocaleString()} ETB`,
    )
    .moveDown();
  ...
  doc
    ...
    .font('Helvetica')
    .text(
      '1. This agreement is a reservation document, not a final sale contract.',
    )
    .text(
      '2. The buyer has paid a reservation fee to hold the vehicle for inspection.',
    )
    ...
    .text(
      '5. Final settlement and ownership transfer must occur at a Transport Authority office.',
    )
    .text(
      '6. The seller guarantees the vehicle is free of liens and encumbrances.',
    )
    .text(
      '7. The buyer accepts the vehicle in its current condition as described.',
    )
    .text(
      '8. Cancellation terms are governed by the Habesha Ride platform policies.',
    )
    .moveDown();
  ...
  doc
    .fontSize(14)
    .font('Helvetica-Bold')
    .text('PLATFORM INFORMATION', { underline: true });
  doc.moveDown(0.5);
  doc
    .fontSize(10)
    .font('Helvetica')
